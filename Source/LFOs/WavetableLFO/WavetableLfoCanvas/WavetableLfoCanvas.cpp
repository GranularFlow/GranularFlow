...
WavetableLfoCanvas::~WavetableLfoCanvas()
{
}

void WavetableLfoCanvas::paintPath(Graphics& g)
{
...
void WavetableLfoCanvas::mouseDrag(const MouseEvent& e)
{
    addPoint(e.x, e.y);
}

float WavetableLfoCanvas::snapToClosestXPoint(float xValue)
{
...
void WavetableLfoCanvas::addPoint(float newX, float newY)
{
...
void WavetableLfoCanvas::mouseDown(const MouseEvent& e)
{
...
float WavetableLfoCanvas::interpolateY(float x, float x1, float y1, float x2, float y2)
{
    return(y1 + (x - x1) * (y2 - y1) / (x2 - x1));
}

void WavetableLfoCanvas::mouseUp(const MouseEvent& e)
{
...
void WavetableLfoCanvas::convertPointsToAmplitude()
{
...
float WavetableLfoCanvas::yValueToAmplitude(float yVal)
{
